  ...
  return (
    <div className="template1-parent">
      ...
      <div className="objective mt-3">
        <h3 style={{backgroundColor:'gray' , padding:5}}>Objective</h3>
        <hr />
      ...
      <div className="education mt-3">
        <h3 style={{backgroundColor:'gray' , padding:5}}>Education</h3>
        <hr />
      ...
      <div className="experience mt-3">
        <h3 style={{backgroundColor:'gray' , padding:5}}>Experience</h3>
        <hr />
      ...
      <div className="projects mt-3">
        <h3 style={{backgroundColor:'gray' , padding:5}}>Projects</h3>
        <hr />
      ...
      <div className="projects mt-3">
        <h3 style={{backgroundColor:'gray' , padding:5}}>Skills</h3>
        <hr />
